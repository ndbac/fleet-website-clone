...
function Live() {
  return (
    <div className="container max-w-screen-xl mx-auto mt-48">
      ...
      <div className="grid grid-cols-3 mt-20 text-center">
        <div className="group text-center cursor-pointer">
          <div className="rounded-3xl mx-10 overflow-hidden">
            <img
              src={live1}
      ...
      <div className="max-w-screen-lg mx-auto mt-14 text-center">
        <button
          type="button"
          class="group border inline-flex items-center px-4 py-2 font-semibold leading-6 text-sm shadow rounded-full text-white hover:bg-slate-700 transition ease-in-out duration-700"
          disabled=""
        >
          <svg
          ...
          <h1 class="text-slate-900 group-hover:text-slate-100 transition ease-in-out duration-700">Loading...</h1>
        </button>
      </div>
    </div>
  );
