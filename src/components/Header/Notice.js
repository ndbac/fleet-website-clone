  ...
  return (
    <div className="wow fadeInUp absolute md:w-72 lg:w-64 xl:w-72 mdml-fit lgml-max ml-12 mbmt-max mdmt-max">
      <div className="bg-white shadow-lg rounded-2xl py-2 px-4 xl:py-4 xl:pl-8 xl:pr-4">
        <h1 className="font-bold text-2xl mt-2 mb-8 text-left">Notifications</h1>

        <div className="grid grid-cols-5 text-left items-center">
          <img src={Avatar1} className="h-10 w-10 flex" />
        ...
        <div className="grid grid-cols-5 text-left items-center mt-8 mb-3">
          <img src={Avatar1} className="h-10 w-10 flex" />
          <div className="col-span-4 ml-4">
